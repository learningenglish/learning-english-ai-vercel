...
export const SITUATION_FRAMES = {
  A1: [
    ...
    { key: "service_ordering", name_vi: "Yêu cầu & gọi món tại điểm dịch vụ" },
  ...
  A2: [
    ...
    { key: "service_ordering_payment", name_vi: "Gọi món & thanh toán tại điểm dịch vụ" },
    { key: "health_appointment", name_vi: "Đặt lịch hẹn & mô tả vấn đề sức khoẻ" },
    { key: "outdoor_weather_activity", name_vi: "Bàn về thời tiết & hoạt động ngoài trời" },
