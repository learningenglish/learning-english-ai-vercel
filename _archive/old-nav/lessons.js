// ============================================================================
// ĐÃ LƯU TRỮ (archive) 2026-08-06 — bản GỐC của app/js/views/lessons.js TRƯỚC khi tái cấu trúc
// theo cây mới (Minh: "Chuyên ngành -> Bài học/Hội thoại/Phân tích/Luyện viết", loại Tin tức/Yêu
// thích cũ/Thư viện AI cũ khỏi luồng chính). File thật đã được VIẾT LẠI hoàn toàn, gọn hơn nhiều
// (bỏ mode "favorite"/"library"/nhánh Tin tức, chỉ còn 1 mode duy nhất, lọc theo goal_id đang
// active). Giữ nguyên bản này để tham khảo/khôi phục logic Yêu thích/Thư viện AI/carousel Lĩnh
// vực nếu sau này cần dùng lại — KHÔNG chạy được nguyên trạng (import "../db.js" v.v. vẫn đúng
// đường dẫn tương đối gốc NẾU copy trở lại app/js/views/, nhưng 1 số hàm trong db.js đã đổi/gỡ
// theo đợt tái cấu trúc này, xem docs/NHAT-KY-LAM-VIEC.md mục 2026-08-06).
// ============================================================================
