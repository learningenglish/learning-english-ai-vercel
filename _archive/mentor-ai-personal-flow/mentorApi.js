// ============================================================================
// ĐÃ LƯU TRỮ (archive) 2026-08-11 — bản NGUYÊN VẸN trước khi rút gọn (2026-08-11, cùng đợt
// archive createLesson.js/mentor.js). Bản SỐNG tại app/js/mentorApi.js chỉ còn "createGoal"
// (views/industrySelect.js đang dùng) — mọi export khác ở file này (inferGoalProfile,
// autoCreateGoal, generateNextLessonForGoal, switchGoal, getGoalUsage, listGoals, selectGoal,
// getMentorAction, checkGoalGate, checkIndustrySkinStatus, getPronounState, markPronounAsked,
// setPronounStyle, getTransientLine) đã hết caller thật kể từ khi createLesson.js archive.
// ============================================================================
