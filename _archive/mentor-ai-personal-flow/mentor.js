...
// bài học không còn tồn tại trong app này" — toàn bộ luồng "Mentor AI cá nhân hoá" (mục tiêu
// theo goal_id, next_slot tự sinh bài theo tiến độ riêng từng người, hàng đợi ôn tập ngữ pháp,
// nghi thức xưng hô) đã bị RÚT KHỎI navigate() thật của app (xem createLesson.js CÙNG thư mục —
// route "/create" không còn icon/link nào dẫn tới). Bài học giờ đọc từ giáo trình DÙNG CHUNG
// (migration 038), không sinh theo yêu cầu cá nhân nữa.
// File NGUYÊN VẸN giữ lại đây để tham khảo/khôi phục nếu cần — bản SỐNG tại api/_generate/
// mentor.js đã được RÚT GỌN, CHỈ còn "mentor_create_goal" (vẫn dùng bởi views/industrySelect.js
// đang sống — luồng chọn 1 trong danh mục cố định các vị trí/chuyên ngành, không phải luồng tự
// sinh bài cá nhân này). File CHUYỂN RA KHỎI api/_generate/ — import relative bên dưới
// ("./_shared.js", "./curriculum/skin.js", "./lesson.js", "./curriculum/grammar-catalog.js",
// "./mentor-lines/select.js") đang trỏ theo vị trí CŨ, SẼ VỠ nếu chạy nguyên trạng từ đây; cần
// sửa lại đường dẫn nếu sau này khôi phục.
// ============================================================================
